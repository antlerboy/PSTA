...
def css_fix():
    ...
    s+=mark+'''\n.brand{width:300px;min-height:100px;padding:8px 12px;background:#fff;border-radius:8px;display:flex;align-items:center;justify-content:flex-start}.brand img{display:block;width:auto;height:84px;max-width:100%;max-height:84px;object-fit:contain;object-position:left center;background:#fff}.footer-logo{display:inline-flex;align-items:center;padding:10px 12px;background:#fff;border-radius:8px;max-width:300px}.footer-logo img{display:block;width:auto;height:82px;max-width:100%;max-height:82px;object-fit:contain;background:#fff}.partner-logo-wrap{display:flex;align-items:center;justify-content:center;min-height:120px;margin-bottom:1rem;padding:1rem;background:#fff;border:1px solid var(--line);border-radius:12px}.partner-logo{display:block;width:auto;max-width:230px;height:auto;max-height:86px;object-fit:contain}.partner-logo-fallback{font-size:1.3rem;font-weight:800;color:var(--blue)}.iteration-secret-link{background:#fff!important;opacity:1!important}.announcement{background:var(--blue)!important}.skip-link{background:var(--blue)!important}.cta-panel{background:var(--cyanwash)!important;color:var(--ink)!important}.cta-panel h2,.cta-panel p{color:var(--ink)!important}.cta-panel .eyebrow,.cta-panel .text-link{color:var(--blue)!important}.button:hover{background:var(--mid)!important;border-color:var(--mid)!important}@media(max-width:760px){.brand{width:230px;min-height:82px}.brand img{height:66px;max-height:66px}}\n'''
